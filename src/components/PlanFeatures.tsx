// src/components/PlanFeatures.tsx - New component to show available features
...
export const PlanFeaturesDisplay: React.FC<PlanFeaturesProps> = ({ currentPlan }) => {
  ...
  const featureList = [
    ...
    { name: 'Analytics & Advantage Analysis', enabled: features.hasBettingInsights, plan: 'analytics' },
