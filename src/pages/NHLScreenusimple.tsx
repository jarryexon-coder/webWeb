// Web version of NHLScreenusimple
...
// Original screen: ../nba-frontend-clean/src/screens/NHLScreenusimple.js

const NHLScreenusimple = () => {
  return (
...
export default NHLScreenusimple
