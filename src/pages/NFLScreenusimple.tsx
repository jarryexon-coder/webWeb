// Web version of NFLScreenusimple
...
// Original screen: ../nba-frontend-clean/src/screens/NFLScreenusimple.js

const NFLScreenusimple = () => {
  return (
...
export default NFLScreenusimple
