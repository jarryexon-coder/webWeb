// Web version of EditorsUpdateScreen
...
// Original screen: ../nba-frontend-clean/src/screens/EditorsUpdateScreen.js

const EditorsUpdateScreen = () => {
  return (
...
export default EditorsUpdateScreen
