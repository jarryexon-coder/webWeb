// Web version of SuperStatsHubScreen
...
// Original screen: ../nba-frontend-clean/src/screens/SuperStatsHubScreen.js

const SuperStatsHubScreen = () => {
  return (
...
export default SuperStatsHubScreen
