// Web version of HomeScreenuminimal
...
// Original screen: ../nba-frontend-clean/src/screens/HomeScreenuminimal.js

const HomeScreenuminimal = () => {
  return (
...
export default HomeScreenuminimal
